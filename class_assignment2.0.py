'''
2.EXECUTE ALL METHODS OF LIST,DICRIONARY, STRINGS IN W3SCHOOLS
'''




#1 change values in a list and a dictionary.
l1=[22,33,44]
l1[0]=55
print(l1)
...
#2 EXECUTE ALL METHODS OF LIST IN W3SCHOOLS
#append
a=[1,2,3,4,5]
a.append(6)
print(a)
...
#3 EXECUTE ALL METHODS OF DICRIONARY IN W3SCHOOLS
#copy
...
#4 EXECUTE ALL METHODS OF STRINGS IN W3SCHOOLS
str = "methods"
